...
Before saving the request file, replace the file content with the string \*data\* and filename.ext with the string \*filename\* and Content-Type header with \*mimetype\*.
